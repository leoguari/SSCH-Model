...
aEffectUHPH=c(0, 3.6) #scenario -- intervention -- from meta-analysis data on processed foods one year follow up
aEffectInfra=c(0, 0.043) #scenario -- intervention study from New Orleans - no CI
aRRPACampaign=c(0, 1.25) #scenario -- intervention -- meta-analysis on mass media campaigns
aIGTrecovery=10 #intervention -- assumption/intervention
...
aElasFVPrice=c(1.2, 1.0, 1.2, 15) #range - Afshin & Penalvo et al
...
aElasticity.Bus.Fare=0.15 #range? -- assumption
